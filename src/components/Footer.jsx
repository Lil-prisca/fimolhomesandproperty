...
text-sm"
        ...
        <div className=" grid grid-cols-1 md:grid-cols-2 lg:flex lg:justify-around gap-10 lg:gap-20 mb-16">
          {/* Brand column */}
          <div className=" lg:col-span-2">
            ...
            <div className="space-y-3 text-sm text-white/50">
              <div className="flex items-start gap-3">
                <svg
                  className="w-4 h-4 text-blue-400 mt-0 shrink-0"
                  viewBox="0 0 16 16"
                  fill="none"
                >
                  <path
              ...
              <div className="flex flex-col gap-1  lg:flex-row">
                {[
                  ...
                  <div key={phone.num} className=" ">
                    ...
                    >
                      <svg
                        className={`flex  w-5 h-5  justify-center align-middle items-center  text-${phone.col} shrink-0`}
                        fill={phone.col2}
            ...
            {/* Socials */}
            <div className="lg:w-fit flex mx-auto gap-3 lg:gap-7 mt-7">
              {socials.map((s) => (
                <motion.a
                  key={s.label}
                  href={s.href}
          ...
          {/* Link columns */}
          <div className=" lg:w-2xl lg:flex gap-20">
            {Object.entries(footerLinks).map(([heading, links]) => (
              <div key={heading} className=" ">
                <h4 className="text-white text-sm font-semibold mb-2 mt-5 tracking-wide">
                  {heading}
                </h4>
